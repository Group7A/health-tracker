(function () {
  ...
  SettingsController.$inject = ['$scope', 'Authentication', 'UsersService', 'PasswordValidator', 'Notification'];

  function SettingsController($scope, Authentication, UsersService, PasswordValidator, Notification) {
    var vm = this;
